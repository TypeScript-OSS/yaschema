...
const swds1: SchemaWithDynamicSubschema<'hello' | 'world'> = { wmo: { myMixedObjects: { a: 1, b: '2' } }, value: 'hello' };
const swds2: SchemaWithDynamicSubschema<'hello' | 'world'> = { wmo: { myMixedObjects: { a: 1, b: '2' } }, value: undefined };
console.log(swds1, swds2);
